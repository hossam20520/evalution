            ...
            <div class="box">
              ...
              <div class="box-body">
                <div id="example1_wrapper" class="form-inline dt-bootstrap">
                  ...
                  <?php $__currentLoopData = $statment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>        
                      
                  <tr class="odd">
                        <td><img src="../<?php echo e($rows['photo']); ?>" alt="<?php echo e($rows['name']); ?>"></td>
                        <td><?php echo e($rows['name']); ?></td>
                        <td><?php echo e($rows['Date']); ?></td>
                        <td><i class="fa fa-male"></i></td>
                        <?php if($rows['statues'] == "disactive"): ?>
                        <td><button class="btn btn-danger"><?php echo e($rows['statues']); ?></button></td>
                        <?php else: ?>
                        <td><button class="btn btn-success"><?php echo e($rows['statues']); ?></button></td>
                        <?php endif; ?>
                        <td><?php echo e($rows['org']); ?></td>
                        <td class=" text-center">
                            <button  type="button"  data-id="<?php echo e($rows['id']); ?>" data-edit="yes" class="edit-button btn btn-success editUser" data-toggle="modal" data-target=".user-add">
                            <i class="glyphicon glyphicon-pencil"></i>
                            </button>
                            <button type="button" class="edit-button btn btn-danger rmove"  data-id="<?php echo e($rows['id']); ?>" data-toggle="modal" data-target=".romove-popup">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hossam/Documents/evalution/anubis/views/users.blade.php ENDPATH**/ ?>