          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="../<?php echo e($info['photo']); ?>" class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo e($info['name']); ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="../<?php echo e($info['photo']); ?>" class="img-circle" alt="User Image">
            ...
            <div class="col-md-3">
              ...
              <div class="box box-primary">
                <div class="box-body box-profile">
                  <img class="profile-user-img img-responsive img-circle" src="../<?php echo e($info['photo']); ?>" alt="User profile picture">
    
                  <h3 class="profile-username text-center"><?php echo e($info['name']); ?></h3>
    
                  <p class="text-muted text-center">Admin</p>
    
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>Gender</b> <a class="pull-right"><?php echo e($info['gender']); ?></a>
                    </li>
                    <li class="list-group-item">
                      <b>Phone</b> <a class="pull-right"><?php echo e($info['phone']); ?></a>
                    </li>
                    <li class="list-group-item">
                  ...
                  <div class="profile-form">
                    <form class="form-horizontal" method="post" action="profile">
                      <div class="form-group">
                        ...
                        <label  class="col-sm-3 control-label titles"><?php echo e($info['name']); ?></label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9 cont">
                        <label  class="col-sm-3 control-label titles"><?php echo e($info['phone']); ?></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-9 cont">
                          <label  class="col-sm-3 control-label titles"><?php echo e($info['email']); ?></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-9 cont">
                          <label  class="col-sm-3 control-label titles"><?php echo e($info['org']); ?></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-9 cont">
                          <label  class="col-sm-3 control-label titles"><?php echo e($info['gender']); ?></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-9 cont">
                          <label  class="col-sm-3 control-label titles"><?php echo e($info['password']); ?></label>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hossam/Documents/evalution/anubis/views/subprofile.blade.php ENDPATH**/ ?>