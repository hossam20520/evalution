...
">>
  ...
  <section class="content">
    ...
    @foreach($statment as $ads)
 
    <tr role="row" class="odd">
                        <td><a href="#"><img src="{{$ads['img_url']}}" alt="{{$ads['img_url']}}"></a></td>
                        <td>{{$ads['title_ads']}}</td>
                        <td><button class="btn btn-success">{{$ads['statues']}}</button></td>
                        <td>{{$ads['note_ads']}}</td>
                        <td class=" text-center">
                          <button type="button" class="btn btn-success which" data-edit ="yes"  data-id="{{$ads['id_ads']}}" data-toggle="modal" data-target=".ads-add">
                            <i class="glyphicon glyphicon-pencil"></i>
                          </button>
                          <button type="button" class="btn btn-danger rmove"  data-id="{{$ads['id_ads']}}"  data-toggle="modal" data-target=".romove-popup">
                ...
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      @foreach($org as $orgs)
                        <option value="{{$orgs['id_org']}}">{{$orgs['name_org']}}</option>
